...
const Color kDarkPrimary = Color(0xFF6dc4e1);
const Color kDarkAccent = kDarkPrimary;
const Color kDarkTextColor = Colors.white;
const Color kDarkPlaceholder = Color(0xFF498396);
const Color kDarkPlaceholderText = Color(0xFF305764);
const Color kDarkBg = Color(0xFF3d6d7d);
