...
class AngleBloc extends Bloc<AngleEvent, AngleState> {
  ...
  AngleBloc(this.qiblaDirection) : super(const AngleInitial(0, 0)) {
    on<SetMagnetometerValue>((event, emit) {
      setMagnetoMeter(event, emit);
    });
  }

  void setMagnetoMeter(event, emit) async {
